...
class ReactionButton2<T> extends StatefulWidget {
  ...
  @override
  State<ReactionButton2<T>> createState() => ReactionButtonState<T>();
}

class ReactionButtonState<T> extends State<ReactionButton2<T>> {
