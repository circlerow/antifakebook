...
class FriendRepositoryImpl implements FriendRepository {
  ...
  Future<dynamic> getUserFriends(
    ...
    final http.Response response = await request('/get_user_friends', 'POST',
        isToken: true,
        body: {"index": index, "count": count, "user_id": userId});
  ...
  Future<dynamic> setRequestFriend(String userId) async {
    final http.Response response = await request('/set_request_friend', 'POST',
  ...
  Future<dynamic> setAcceptFriend(String userId, String isAccept) async {
    final http.Response response = await request('/set_accept_friend', 'POST',
        isToken: true, body: {"user_id": userId, "is_accept": isAccept});
    Map<String, dynamic> data = json.decode(response.body);
    return data;
  }
  ...
  Future<dynamic> unFriend(String userId) async {
    final http.Response response = await request('/unfriend', 'POST',
        isToken: true, body: {"user_id": userId});
    Map<String, dynamic> data = json.decode(response.body);
    return data;
  }
  ...
  Future<dynamic> delRequestFriend(String userId) async {
    final http.Response response = await request('/del_request_friend', 'POST',
        isToken: true, body: {"user_id": userId});
    Map<String, dynamic> data = json.decode(response.body);
    return data;
  }
  ...
  Future<dynamic> blockFriend(String userId) async {
    final http.Response response = await request('/set_block', 'POST',
        isToken: true, body: {"user_id": userId});
    Map<String, dynamic> data = json.decode(response.body);
    return data;
  }
  ...
  Future<dynamic> listBlock(dynamic body) async {
    final http.Response response =
        await request('/get_list_blocks', 'POST', isToken: true, body: body);
    Map<String, dynamic> data = json.decode(response.body);
    return data;
  }
  ...
  Future<dynamic> unBlockFriend(String userId) async {
    final http.Response response = await request('/unblock', 'POST',
        isToken: true, body: {"user_id": userId});
    Map<String, dynamic> data = json.decode(response.body);
    return data;
  }
